...
(def org-file
  ...
  (or (System/getenv "DBDOC_ORG")  "docs/dbdoc.org"))
(def html-file
...
(defn remove-old-migrations
  "Delete older migration file(s).
  Assume was successful in creating a new mig."
  []
  (doseq [f (fs/glob mig-dir "*-dbdoc.up.sql" {:max-depth 1})]
    (println "Deleting old:" (.toString f))
    (fs/delete f)))
